...
```{r getting fragment length profile distribution,warning=FALSE, fig.width=4, fig.height=3}
sample_profile = 
...
```{r plot genome-wide SLRatio, warning=FALSE, fig.width=4, fig.height=2}
...
```{r Reading-in Panel-of-Normal samples and plot scaled value,warning=FALSE,fig.width=4, fig.height=2}
...
```{r cnv calling and plot distance matrix,warning=FALSE,fig.width=4, fig.height=3}
...
```{r plot cnv-calling first solution,warning=FALSE,fig.width=4, fig.height=2}
