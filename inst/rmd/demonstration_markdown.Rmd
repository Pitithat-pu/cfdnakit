...
This rmarkdown to demonstrate how cfdnakit work.
First, load cfdnakit package to environment
...
```{r getting fragment length profile}
sample_profile = 
...
```{r Reading-in Panel-of-Normal samples and plot scaled value}
...
plot_transformed_sl(sample_zscore)
